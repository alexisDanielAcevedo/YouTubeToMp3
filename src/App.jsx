    ...
    try {
      ...
      const youtubeApiResponse = await axios.get('https://youtube.googleapis.com/youtube/v3/videos', {
        params: {
          part: 'snippet',
          id: videoId,
          key: import.meta.env.VITE_REACT_APP_APIKEY_YOUTUBE, // Reemplaza con tu clave de API
        },
      });
      ...
      const rapidApiResponse = await axios.get('https://youtube-mp3-downloader2.p.rapidapi.com/ytmp3/ytmp3/', {
        ...
        headers: {
          'X-RapidAPI-Key': import.meta.env.VITE_REACT_APP_APIKEY_RAPIDAPI,
          'X-RapidAPI-Host': import.meta.env.VITE_REACT_APP_HOST_RAPIDAPI,
        },
      });
